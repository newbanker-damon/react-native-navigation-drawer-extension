...
var react_native_navigation_1 = require("@newbanker/react-native-navigation");
    ...
    RNNDrawer.create = function (Component) {
        var WrappedDrawer = /** @class */ (function (_super) {
            ...
            WrappedDrawer.prototype.render = function () {
                ...
                /** Props */
                var _a = this.props, direction = _a.direction, style = _a.style, disablePanGesture = _a.disablePanGesture;
                /** State */
                ...
                return (React.createElement(react_native_1.View, __assign({ style: sideMenuContainerStyle }, (disablePanGesture ? {} : this.panResponder.panHandlers)),
